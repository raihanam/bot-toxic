...
*/
const XPTN = 'AN BOT'; // Nama Bot Whatsapp
const instagram = 'https://instagram.com/amirrehan211'; // Nama Instagramlu cok
const nomer = 'https://Wa.me/+6285281968399'; // Nomor whatsapplu cok
const aktif = 'jika di aktifkan'; // Kapan bot lu aktif
const groupwa = 'gak ada'; // OFFICIAL GRUP LU 1
const youtube = 'gak ada'; // OFFICIAL GRUP LU 2
//
...
conn.sendMessage(id, 'Owner AN BOT wa.me/+6285281968399' ,MessageType.text);
}
else if (text == 'andika'){
conn.sendMessage(id, 'Aku BOT nya ANDIKA' ,MessageType.text);
}
else if (text == 'siapa pacar owner'){
conn.sendMessage(id, 'dia jomblo cuk, pacarin dia lah, biar dia happy' ,MessageType.text);
}
else if (text == 'bangsat'){
conn.sendMessage(id, 'toxic terdeteksi' ,MessageType.text);
}
else if (text == 'Ngentod'){
conn.sendMessage(id, 'Pengin ngentod?, yaudah sini' ,MessageType.text);
}
else if (text == 'Anjing'){
...
conn.sendMessage(id, ' *COMMAND PREMIUM CHAT WA https://wa.me/6285281968399* ' ,MessageType.text);
}
else if (text == 'Woi'){
conn.sendMessage(id, 'Ya?, Ketik .help/.info/.donasi Contoh #help' ,MessageType.text);
}
...
conn.sendMessage(id, 'CAHYA Add CAHYA asik dia CHAT AJA OWNER' ,MessageType.text);
}
else if (text == '.coowner'){
conn.sendMessage(id, 'ANDIKA add ANDIKA wa.me/+6285281968399' ,MessageType.text);
}
else if (text == '.groupbot'){
conn.sendMessage(id, 'gak ada boss' ,MessageType.text);
}
else if (text == '.tools1'){
  ...
  var teks = text.replace(/.nulis /, '')
    ...
    .then((res) => {
      imageToBase64(res.data.result)
        .then(
          (ress) => {
            conn.sendMessage(id, '[WAIT] Sabar njing lagi nulis❗', MessageType.text)
  ...
  var teks = text.replace(/.tts2 /, '')
    ...
    .then((res) => {
      audioToBase64(res.data.result)
        .then(
          (ress) => {
            conn.sendMessage(id, '[WAIT] Sabar anjing❗', MessageType.text)
            var buf = Buffer.from(ress, 'base64')
...
axios.get(`https://st4rz.herokuapp.com/api/yta?url=${teks}`).then((res) => {
    let hasil = `noh anjing  hasilnya download sendiri\n👇👇👇👇👇👇👇👇👇\n\nJudul: ${res.data.title}\n\nUkuran audio: ${res.data.filesize}\n\nLink: ${res.data.result}`;
...
axios.get(`https://st4rz.herokuapp.com/api/ytv?url=${teks}`).then((res) => {
    let hasil = `noh njing  hasilnya download sendiri sono\n\n\nJudul: ${res.data.title}\n\nUkuran video: ${res.data.filesize}\n\nLink: ${res.data.result}`;
    conn.sendMessage(id, hasil ,MessageType.text);
})
}
...
axios.get(`https://api.haipbis.xyz/bitly?url=${teks}`).then((res) => {
	conn.sendMessage(id, '[WAIT] Sabar njing❗', MessageType.text)
    let hasil = `nih kak :) \n\n${res.data.result}`;
    conn.sendMessage(id, hasil ,MessageType.text);
})
}
  ...
  var teks = text.replace(/.cooltext /, '')
    ...
    .then((res) => {
      imageToBase64(res.data.image)
        .then(
          (ress) => {
            conn.sendMessage(id, '[❗] SABAR ANJING', MessageType.text)
            var buf = Buffer.from(ress, 'base64')
            conn.sendMessage(id, buf, MessageType.image)
        })
    })
...
axios.get(`https://api.haipbis.xyz/randomcooltext?text=${teks}`).then((res) => {
	conn.sendMessage(id, '[WAIT] SABAR ANJINGG❗', MessageType.text)
...
axios.get(`https://arugaz.herokuapp.com/api/wikien?q=${teks}`).then((res) => {
	conn.sendMessage(id, '[WAIT] SABAR ANJING DI CARIIN ❗', MessageType.text)
...
axios.get(`https://arugaz.herokuapp.com/api/howgay`).then((res) => {
	conn.sendMessage(id, '[WAIT] SABAR ORANG BODOH❗', MessageType.text)
...
conn.sendMessage(id, '[WAIT] KALO TAU NAMANYA SABAR YA SABAR ANJING❗', MessageType.text)
...
conn.sendMessage(id, '[WAIT] SABAR WOI❗', MessageType.text)
    let hasil = ` *Nih Puisinya Kak :)*\n\n _${res.data.result}_ `;
    conn.sendMessage(id, hasil ,MessageType.text);
})
}
...
conn.sendMessage(id, '[WAIT] SABAR BEGO❗', MessageType.text)
...
conn.sendMessage(id, '[WAIT] TOBAT WOI ANJING LAH❗', MessageType.text)
...
conn.sendMessage(id, '[WAIT] TOBAT ANJING YA ALLAH'❗', MessageType.text)
    let hasil = ` *Nih cersex Kak :)*\n\n _${res.data.result}_ `;
    conn.sendMessage(id, hasil ,MessageType.text);
})
}
...
axios.get(`https://arugaz.herokuapp.com/api/dewabatch?q=${teks}`).then((res) => {
	conn.sendMessage(id, '[WAIT] SABAR NGENTOD❗', MessageType.text)
...
const animes =  axios.get(`https://mhankbarbar.herokuapp.com/api/otakudesu?q=${teks}&apiKey=F0Zuy3oCaQogy9MOt3tk`).then((res) => {
    let hasil = ` *Nih anjing nya 😂😂 jangan di bawa ke ginjall ehh ke hati:)*\n\n _${animes.data.title}\n\n${animes.data.info}\n\n${animes.data.sinopsis}_ `;
...
axios.get(`https://arugaz.herokuapp.com/api/spamcall?no=${teks}`).then((res) => {
	conn.sendMessage(id, '[WAIT] STERS ANDA❗', MessageType.text)
...
axios.get(`https://arugaz.herokuapp.com/api/howbucins`).then((res) => {
	conn.sendMessage(id, '[WAIT] BUCIN TEROS, NYIMAK GUA ANJING❗', MessageType.text)
...
axios.get(`https://arugaz.herokuapp.com/api/indohot`).then((res) => {
	conn.sendMessage(id, '[WAIT] TOBAT BEGO YA ALLAH❗', MessageType.text)
...
axios.get(`https://arugaz.herokuapp.com/api/sdmovie?film=${teks}`).then((res) => {
	conn.sendMessage(id, '[WAIT] PECINTA ANIME YA, SABAR YA KAK❗', MessageType.text)
...
if (text.includes(".infoig")){
  ...
  conn.sendMessage(id, '[WAIT] Sabar lagi ujian ⏳', MessageType.text)
...
if (text.includes(".infogempa")){
  ...
  conn.sendMessage(id, '[WAIT] emang gempa mau di apain bang, sabar ya bang⏳', MessageType.text)
...
axios.get(`https://alfians-api.herokuapp.com/api/ytv?url=${teks}`).then((res) => {
	conn.sendMessage(id, '[WAIT] SABAR KONTO*⏳', MessageType.text)
...
axios.get(`https://mhankbarbar.herokuapp.com/api/twit?url=${teks}&apiKey=zFuV88pxcIiCWuYlwg57`).then((res) => {
	conn.sendMessage(id, '[WAIT] SABAR DI SAYANG TUHAN LOH❗', MessageType.text)
...
axios.get(`https://arugaz.herokuapp.com/api/wiki?q=${teks}`).then((res) => {
	conn.sendMessage(id, '[WAIT] NYARI ITU DI WIKI PEDIA NYA LANGSUNG GAK PUNYA PAKET KAH❗', MessageType.text)
...
if (text.includes(".sholat")){
  ...
  conn.sendMessage(id, '[WAIT] Sabar soleha❗', MessageType.text)
...
axios.get(`https://masak-apa.tomorisakura.vercel.app/api/search/?q=${teks}`).then((res) => {
	conn.sendMessage(id, '[WAIT] sabar ya bund❗', MessageType.text)
...
axios.get(`https://api.terhambar.com/ninja?nama=${teks}`).then((res) => {
	conn.sendMessage(id, '[WAIT] Sabar.❗', MessageType.text)
